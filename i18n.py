...
TRANSLATIONS: Dict[str, Dict[str, str]] = {
    ...
    "nav.academics": {"en": "Academics", "ar": "الإدارة الأكاديمية"},
    "acad.courses_desc": {"en": "Academic courses and prerequisites", "ar": "المقررات الأكاديمية والمتطلبات السابقة"},
    "acad.majors_desc": {"en": "Majors and study plans", "ar": "التخصصات والخطط الدراسية"},
    "acad.lms_desc": {"en": "Learning / training courses", "ar": "الدورات التعليمية والتدريبية"},
    "lms.title": {"en": "Course title", "ar": "عنوان الدورة"},
    "lms.category": {"en": "Category", "ar": "التصنيف"},
    "lms.instructor": {"en": "Instructor", "ar": "المدرّب"},
    "lms.description": {"en": "Description", "ar": "الوصف"},
    "lms.disabled": {"en": "disabled", "ar": "معطّل"},
    "lms.enable_hint": {"en": "The learning system is disabled. Enable it from Account settings to publish courses.", "ar": "نظام التعلم معطّل. فعّله من إعدادات الحساب لنشر الدورات."},
    # -- Academy: external trainees + training courses ---------------------
    "academy.title": {"en": "Training Academy", "ar": "أكاديمية التدريب"},
    "academy.catalog": {"en": "Courses", "ar": "الدورات"},
    "academy.my_courses": {"en": "My courses", "ar": "دوراتي"},
    "academy.register": {"en": "Create account", "ar": "إنشاء حساب"},
    "academy.have_account": {"en": "Already have an account?", "ar": "لديك حساب؟"},
    "academy.no_account": {"en": "No account yet?", "ar": "ليس لديك حساب؟"},
    "academy.enrolled_badge": {"en": "Enrolled", "ar": "مسجّل"},
    "academy.payment": {"en": "Payment", "ar": "الدفع"},
    "academy.pay_pending": {"en": "Awaiting payment", "ar": "بانتظار الدفع"},
    "academy.pay_paid": {"en": "Paid", "ar": "مدفوع"},
    "academy.pay_refunded": {"en": "Refunded", "ar": "مسترد"},
    "academy.in_progress": {"en": "In progress", "ar": "قيد التقدّم"},
    "academy.completed_badge": {"en": "Completed", "ar": "مكتملة"},
    "academy.certificate": {"en": "Certificate", "ar": "الشهادة"},
    "academy.no_enrollments": {"en": "You have no courses yet.", "ar": "لا دورات لك بعد."},
    "academy.mode_content": {"en": "Self-paced", "ar": "ذاتي"},
    "academy.mode_session": {"en": "Scheduled sessions", "ar": "جلسات مجدولة"},
    "academy.mode_hybrid": {"en": "Hybrid", "ar": "هجين"},
    "academy.login_to_enroll": {"en": "Log in to enroll", "ar": "سجّل الدخول للتسجيل"},
    "academy.enroll_now": {"en": "Enroll", "ar": "سجّل في الدورة"},
    "academy.awaiting_payment": {"en": "Enrollment recorded — awaiting payment confirmation.", "ar": "تم التسجيل — بانتظار تأكيد الدفع."},
    "academy.mark_complete": {"en": "Mark as complete", "ar": "وسم كمكتملة"},
    "academy.content": {"en": "Content", "ar": "المحتوى"},
    "academy.open_link": {"en": "Open link", "ar": "فتح الرابط"},
    "academy.no_content": {"en": "No content yet.", "ar": "لا محتوى بعد."},
    "academy.content_locked": {"en": "Content unlocks after payment is confirmed.", "ar": "يُفتح المحتوى بعد تأكيد الدفع."},
    "academy.enrolled": {"en": "Enrolled — access is open.", "ar": "تم التسجيل — الوصول مفتوح."},
    "academy.enroll_pending": {"en": "Enrolled — awaiting payment confirmation.", "ar": "تم التسجيل — بانتظار تأكيد الدفع."},
    "academy.completed": {"en": "Course completed. Your certificate is ready.", "ar": "اكتملت الدورة. شهادتك جاهزة."},
    "academy.price": {"en": "Price", "ar": "السعر"},
    "academy.delivery_mode": {"en": "Delivery mode", "ar": "نمط التقديم"},
    "academy.completion_rules": {"en": "Completion requirements", "ar": "شروط الإكمال"},
    "academy.require_content": {"en": "Finish all content", "ar": "إنهاء كل المحتوى"},
    "academy.require_quiz": {"en": "Pass the quiz", "ar": "اجتياز الاختبار"},
    "academy.require_attendance": {"en": "Minimum attendance", "ar": "الحد الأدنى للحضور"},
    "academy.lesson_body": {"en": "Lesson text", "ar": "نص الدرس"},
    "academy.lesson_link": {"en": "Link (video/resource)", "ar": "رابط (فيديو/مصدر)"},
    "academy.enrollments": {"en": "Enrollments", "ar": "التسجيلات"},
    "academy.trainee": {"en": "Trainee", "ar": "المتدرّب"},
    "academy.amount": {"en": "Amount", "ar": "المبلغ"},
    "academy.ref": {"en": "Reference", "ar": "المرجع"},
    "academy.approve_payment": {"en": "Confirm payment", "ar": "تأكيد الدفع"},
    "academy.pending_payments": {"en": "Pending payments", "ar": "مدفوعات معلّقة"},
    "academy.sessions": {"en": "Sessions", "ar": "الجلسات"},
    "academy.no_sessions": {"en": "No sessions scheduled yet.", "ar": "لا جلسات مجدولة بعد."},
    "academy.session_date": {"en": "Date", "ar": "التاريخ"},
    "academy.session_time": {"en": "Time", "ar": "الوقت"},
    "academy.online": {"en": "Online", "ar": "عن بُعد"},
    "academy.online_link": {"en": "Online link", "ar": "رابط عن بُعد"},
    "academy.join": {"en": "Join", "ar": "انضمام"},
    "academy.no_paid_trainees": {"en": "No paid trainees to record attendance for yet.", "ar": "لا متدربين مدفوعين لتسجيل حضورهم بعد."},
    "academy.quiz": {"en": "Quiz", "ar": "الاختبار"},
    "academy.quiz_title": {"en": "Quiz title", "ar": "عنوان الاختبار"},
    "academy.pass_percent": {"en": "Pass mark", "ar": "درجة النجاح"},
    "academy.question": {"en": "Question", "ar": "السؤال"},
    "academy.correct": {"en": "Correct answer", "ar": "الإجابة الصحيحة"},
    "academy.no_questions": {"en": "No questions yet.", "ar": "لا أسئلة بعد."},
    "academy.add_question": {"en": "Add question", "ar": "إضافة سؤال"},
    "academy.your_score": {"en": "Your score", "ar": "درجتك"},
    "academy.passed": {"en": "Passed", "ar": "ناجح"},
    "academy.not_passed": {"en": "Not passed", "ar": "لم تنجح"},
    "academy.submit_quiz": {"en": "Submit answers", "ar": "إرسال الإجابات"},
    "academy.take_quiz": {"en": "Take the quiz", "ar": "ابدأ الاختبار"},
    "academy.view_quiz": {"en": "View result", "ar": "عرض النتيجة"},
    "academy.quiz_passed": {"en": "Passed the quiz. Well done!", "ar": "اجتزت الاختبار. أحسنت!"},
    "academy.quiz_failed": {"en": "Score {score}% — below the pass mark. Try again.", "ar": "درجتك {score}% — أقل من درجة النجاح. حاول مجددًا."},
    "academy.landing_title": {"en": "Training courses", "ar": "الدورات التدريبية"},
    "academy.landing_desc": {"en": "Browse and enroll in paid training courses — open to everyone.", "ar": "تصفّح وسجّل في الدورات التدريبية المدفوعة — متاحة للجميع."},
    "flash.deleted": {"en": "Deleted.", "ar": "تم الحذف."},
    ...
    "timetable.conflicts": {"en": "Timetable conflicts", "ar": "تعارضات الجدول"},
    "timetable.conflict_teacher": {"en": "Teacher double-booked", "ar": "تعارض معلم"},
    "timetable.conflict_room": {"en": "Room double-booked", "ar": "تعارض قاعة"},
    "timetable.conflict_student": {"en": "Student in two overlapping sections",
                                   "ar": "طالب في شعبتين متعارضتين"},
    "timetable.conflict_none": {"en": "No timetable conflicts detected.",
                                "ar": "لا توجد تعارضات في الجدول."},
    "timetable.conflict_flag": {"en": "In a timetable conflict", "ar": "في تعارض بالجدول"},
    "timetable.generate_draft": {"en": "Generate draft timetable", "ar": "ولّد مسوّدة جدول"},
    "timetable.generate_hint": {"en": "Assigns days/times to unscheduled sections, avoiding teacher and room clashes.",
                                "ar": "يوزّع الأيام والأوقات على الشعب غير المجدولة متجنّبًا تعارض المعلم والقاعة."},
    "timetable.draft_done": {"en": "Draft ready: {placed} placed, {unplaced} left unscheduled.",
                             "ar": "جهزت المسوّدة: {placed} مجدولة، {unplaced} تعذّر جدولتها."},
    "timetable.no_term": {"en": "Pick a term first to generate a timetable.",
                          "ar": "اختر فصلًا أولًا لتوليد الجدول."},
    "timetable.overwrite_fixed": {"en": "Also re-place sections that already have a fixed time",
                                  "ar": "أعد جدولة الشعب ذات المواعيد المثبّتة أيضًا"},
    ...
    "status.published": {"en": "Published", "ar": "منشورة"},
    "status.archived": {"en": "Archived", "ar": "مؤرشفة"},
    ...
    "nav.my_plan": {"en": "My plan", "ar": "خطتي الدراسية"},
    "plan.title": {"en": "Study plan", "ar": "الخطة الدراسية"},
    "plan.manage": {"en": "Degree plan", "ar": "الخطة الدراسية"},
    "plan.level": {"en": "Level {n}", "ar": "المستوى {n}"},
    "plan.kind": {"en": "Type", "ar": "النوع"},
    "plan.kind_required": {"en": "Required", "ar": "إجباري"},
    "plan.kind_elective": {"en": "Elective", "ar": "اختياري"},
    "plan.elective_block": {"en": "Elective block", "ar": "الكتلة الاختيارية"},
    "plan.status": {"en": "Progress", "ar": "الحالة"},
    "plan.status_completed": {"en": "Completed", "ar": "مكتملة"},
    "plan.status_in_progress": {"en": "In progress", "ar": "مسجّلة الآن"},
    "plan.status_remaining": {"en": "Remaining", "ar": "متبقية"},
    "plan.prereq_warning": {"en": "Prerequisite not completed: {codes}",
                            "ar": "متطلب سابق لم يُكمل: {codes}"},
    "plan.add_course": {"en": "Add a course to the plan", "ar": "إضافة مادة للخطة"},
    "plan.plan_hours": {"en": "Plan hours", "ar": "ساعات الخطة"},
    "plan.done_hours": {"en": "Completed hours", "ar": "الساعات المكتملة"},
    "plan.remaining_hours": {"en": "Remaining hours", "ar": "الساعات المتبقية"},
    "plan.no_major": {"en": "No major is assigned to your record yet.",
                      "ar": "لا يوجد تخصص مرتبط بسجلك بعد."},
    "plan.empty": {"en": "No study plan has been set for this major yet.",
                   "ar": "لم تُحدَّد خطة دراسية لهذا التخصص بعد."},
    "plan.required_hours": {"en": "Required for graduation", "ar": "المطلوب للتخرج"},
